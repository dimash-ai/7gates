...
equivalent for. See [`ai/README-gpt-gates.md`](../../ai/README-gpt-gates.md).
...
codex exec --sandbox workspace-write "$(cat ai/prompts/final-release-review.md)
$(cat ai/checklists/release-gate.md)
...
Output ONLY the verdict block from the charter, with Step: ship." 2>&1 | tee ai/runs/$1-gpt-gate-release.txt
```

**You persist the verdict**: copy the block verbatim into `ai/reviews/$1/release-verdict.md`
