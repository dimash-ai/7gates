...
[`.ai/README-3gate.md`](.ai/README-3gate.md)); the higher-granularity 7-step flow
([`.ai/README.md`](.ai/README.md)) is the alternative when you want finer checkpoints. `AGENTS.md`
