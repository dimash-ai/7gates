...
flows at a glance) → [`CLAUDE.md`](CLAUDE.md) (the quality bar) → [`harness/README-7step.md`](harness/README-7step.md)
(the full process).
...
|---|------|------|----------|----------|
| 1 | think  | **Opus** | GPT  | `harness/think/<feature>.md` |
| 2 | plan   | **GPT**  | Opus | `harness/plans/<feature>-plan.md` |
| 3 | design | **Opus** | GPT  | `harness/design/<feature>-design.md` |
| 4 | build  | **Opus** | GPT  | code diff in the target repo |
| 5 | review | **GPT**  | Opus | `harness/reviews/<feature>/05-review-pass.md` |
| 6 | test   | **GPT**  | Opus | tests + `harness/runs/<feature>-test.txt` |
| 7 | ship   | **Opus** | GPT  | `harness/handoffs/<feature>-handoff.md` + PR |

Full operating manual, folder layout, and scoring rules: [`harness/README-7step.md`](harness/README-7step.md).
...
| Path | Holds |
|------|-------|
| [`harness/`](harness/)         | The pipeline: prompts, checklists, and per-feature think / plan / design / reviews / handoffs |
...
Each command runs the step's reviewer, saves a scored verdict under `harness/reviews/<feature>/`, and
**stops** — work advances only at score ≥ 9.0. See
[`harness/README-7step.md`](harness/README-7step.md) for the kickoff template and per-step detail.
