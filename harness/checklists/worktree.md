...
files, switch branches, and commit. The `harness/` paper trail stays in the **shared** pipeline
...
add/commit` on `harness/` at the same instant — commit your `harness/` paper trail per feature (or
